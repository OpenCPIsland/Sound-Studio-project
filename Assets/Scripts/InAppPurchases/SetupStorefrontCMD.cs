...
namespace InAppPurchases
{
	public class SetupStorefrontCMD
	{
		...
		public void Execute()
		{
			...
			{
				loadingOverlay.Hide();
				new ShowDialogAndCloseContextCMD(messageDialogOverlay, Localizer.Instance.GetTokenTranslation("companionapp.network.connection.error")).Execute();
				return;
			}
			...
			else
			{
				...
				mwsClient.GetPlayerCardData(OnAccountInformationReceived);
